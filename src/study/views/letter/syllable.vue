...
export default {
    data () {
        return {
            list: ['zhi', 'chi', 'shi', 'ri', 'zi', 'ci', 'si', 'yi', 'wu', 'yu', 'ye', 'yue', 'yuan', 'yin', 'yun', 'ying'],
            voiceList: [],
            curIndex: -1,
            curSrc: ''
        }
    ...
    methods: {
        ...
        initVoices () {
            this.list.map(item => {
                this.voiceList.push(import(/* webpackPrefetch: true */ 'assets/letters/06/' + (item) + '.mp3'));
            })
        },
