...
export default {
    data () {
        return {
            list: ['mobile phone', 'computer', 'television', 'fridge', 'air conditioner', 'fan'],
            voiceList: [],
            imgList: [],
            curIndex: -1,
            curSrc: ''
    ...
    methods: {
        ...
        initVoices () {
            this.list.map(item => {
                this.voiceList.push(import(/* webpackPrefetch: true */ 'assets/english/electric/' + (item) + '.mp3'));
                this.imgList.push(require('assets/english/electric/' + (item) + '.png'));
            })
        },
