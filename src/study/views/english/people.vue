...
export default {
    data () {
        return {
            list: ['brother', 'father', 'grandfather', 'grandma', 'grandmother', 'grandpa', 'mother', 'sister', 'uncle', 'aunt'],
            voiceList: [],
            imgList: [],
            curIndex: -1,
            curSrc: ''
    ...
    methods: {
        ...
        initVoices () {
            this.list.map(item => {
                this.voiceList.push(import(/* webpackPrefetch: true */ 'assets/english/people/' + (item) + '.mp3'));
                this.imgList.push(require('assets/english/people/' + (item) + '.png'));
            })
        },
