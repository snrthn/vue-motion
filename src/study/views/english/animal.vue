...
export default {
    data () {
        return {
            list: ['rooster', 'cattle', 'pig', 'dog', 'cat', 'horse', 'tiger', 'panda', 'bird', 'snail', 'duck', 'fish'],
            voiceList: [],
            imgList: [],
            curIndex: -1,
            curSrc: ''
    ...
    methods: {
        ...
        initVoices () {
            this.list.map(item => {
                this.voiceList.push(import(/* webpackPrefetch: true */ 'assets/english/animal/' + (item) + '.mp3'));
                this.imgList.push(require('assets/english/animal/' + (item) + '.png'));
            })
        },
